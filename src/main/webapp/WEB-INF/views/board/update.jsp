	...
	<form style="margin: 2%;" role="form" class="form-horizontal"
		...
		<div class="form-group row">
			 <div class="col-sm-6">
				<label for="staticEmail" class="col-form-label">BOARD_SEQ</label> <input
					...
					value="${resultMap.BOARD_SEQ}" readonly>
			</div>
			<div class="col-sm-6">
				...
				<input name="BOARD_DATE" type="text" class="form-control" id="staticEmail"
					value="${resultMap.BOARD_DATE}" readonly>
			</div>
		</div>
		<!-- / BOARD_SEQ, BOARD_DATE -->
		...
		<div class="form-group row">
			...
			<input name="MEMBER_SEQ" type="text" readonly class="form-control"
				id="staticEmail" value="${resultMap.MEMBER_SEQ}" >
		</div>
		<!-- / 작성자 -->
		...
		<div class="form-group row">
			...
			<input name="BOARD_TITLE" type="text" class="form-control" value="${resultMap.BOARD_TITLE}">
		</div>
		<!-- / 제목 -->
		...
		<div class="form-group">
			...
			<textarea name="BOARD_CONT" class="form-control" id="exampleTextarea" rows="15">${resultMap.BOARD_CONT}</textarea>
